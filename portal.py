...
# --- 2. ログイン後：アプリ一覧 ---
    ...
    st.link_button("🏢 マンション予想AI（精密エリア価格）", "https://tokyo-mansion-ai-v5-nzxrgbuxzqrtjow6ycqidd.streamlit.app/")
    st.link_button("🏢 マンション予想AI（広範囲賃貸）", "https://pauprok6wtw6vduiecewyj.streamlit.app/")
    st.link_button("🏢 マンション予想AI（エリア賃貸）", "https://lendv3-irrwfe9xdhmtfd5te5lqee.streamlit.app/")
    ...
    st.link_button("🏫 東京教育環境ガイド", "https://qmkp7yf2na9mcxrggjayft.streamlit.app/")
    st.link_button("🚉 最寄り駅検索", "https://moyori-6e5qmrnhwfjieq9wfdtcee.streamlit.app/")
    ...
    st.link_button("📊 営業評価・ボーナス算定", "https://2249xfo47uym6jqsvzcqmn.streamlit.app/") 
